...
LD_LINUX_SHIM_BUILD := $(FINAL_BUILD_DIR)/ld-linux-shim
...
LD_LINUX_SHIM_PATH := $(CROSS_PREFIX)/bin:$(NATIVE_PREFIX)/bin:$(ORIG_PATH)
...
$(FINAL_BUILD_DIR)/.ld-linux-shim.installed: $(LD_LINUX_SHIM_BIN)
